...
ku_src = (ku < ${c['min_ku']}) ? ${c['tmswitch']}*${c['min_ku']} : ${c['tmswitch']}*(prod - eu);
eu_src = (eu < ${c['min_ku']}) ? ${c['tmswitch']}*${c['min_eu']} : ${c['tmswitch']}*(${c['fk']} * (${c['Ce1']}*prod*eu/ku_temp - Ce2s*(eu*eu)/ku_temp));
